...
<body>
	<div id="form">
		...
		<div id="innerform">
			...
			<input type="password" placeholder="Votre mot de passe" id="pwd2">
		</div>
		<a id="submit" href="#">créer un compte</a>
	</div>
	...
	<script>
		...
		$("#submit").on('click', (e)=>{
			...
			$.post("php/creerCompte.php", {'pseudo':pseudo, 'mdp1':pwd1, 'mdp2':pwd2})
			.done((resp)=>{
				if(resp == 1){
